 ...
 *
 */
public class ServerProtocolsPane
extends JPanel
implements BtpSapEntity.Listener
{

  public ServerProtocolsPane (final OperationalBtpSapServer operationalBtpSapServer)
  {
    if (operationalBtpSapServer == null)
      throw new IllegalArgumentException ();
    this.operationalBtpSapServer = operationalBtpSapServer;
    this.table = new JTable (new ServerProtocolsTableModel (operationalBtpSapServer));
