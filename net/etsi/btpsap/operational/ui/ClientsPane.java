 ...
 *
 */
public class ClientsPane
extends JPanel
implements BtpSapEntity.Listener
{

  public ClientsPane (final OperationalBtpSapServer operationalBtpSapServer)
  {
    if (operationalBtpSapServer == null)
      throw new IllegalArgumentException ();
    this.operationalBtpSapServer = operationalBtpSapServer;
    this.table = new JTable (new ClientsTableModel (operationalBtpSapServer));
