 ...
 *
 */
public class ServersPane
extends JPanel
implements BtpSapEntity.Listener
{

  public ServersPane (final OperationalBtpSapServer operationalBtpSapServer)
  {
    if (operationalBtpSapServer == null)
      throw new IllegalArgumentException ();
    this.operationalBtpSapServer = operationalBtpSapServer;
    this.table = new JTable (new ServersTableModel (operationalBtpSapServer));
